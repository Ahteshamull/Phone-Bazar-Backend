...
export const deletePartnerTransaction = asyncHandler(async (req, res) => {
    ...
    if (!deleted)
        throw new AppError("Partner transaction record was not found", 404, "PARTNER_TRANSACTION_NOT_FOUND");
...
export const deleteExpense = asyncHandler(async (req, res) => {
    ...
    if (!deleted)
        throw new AppError("Shop expense record was not found", 404, "SHOP_EXPENSE_NOT_FOUND");
